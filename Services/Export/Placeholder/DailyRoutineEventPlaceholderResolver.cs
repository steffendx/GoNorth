...
{
    /// <summary>
    /// Class for resolving the placeholders for a single daily routine event
    /// </summary>
    public class DailyRoutineEventPlaceholderResolver : IDailyRoutineEventPlaceholderResolver
    {
        /// <summary>
        ...
        public DailyRoutineEventPlaceholderResolver(IExportCachedDbAccess cachedDbAccess, IDailyRoutineFunctionNameGenerator dailyRoutineFunctionNameGenerator, IStringLocalizerFactory localizerFactory)
        {
            _cachedDbAccess = cachedDbAccess;
            _dailyRoutineFunctionNameGenerator = dailyRoutineFunctionNameGenerator;
            _localizer = localizerFactory.Create(typeof(DailyRoutineEventPlaceholderResolver));
        }
