...
namespace GoNorth.Services.Export.Dialog
{
    ...
    /// </summary>
    public abstract class ExportDialogBaseStepRenderer
    {
        /// <summary>
        ...
        public ExportDialogBaseStepRenderer(ExportPlaceholderErrorCollection errorCollection, IStringLocalizerFactory localizerFactory)
        {
            _errorCollection = errorCollection;
            _baseLocalizer = localizerFactory.Create(typeof(ExportDialogBaseStepRenderer));
        }
