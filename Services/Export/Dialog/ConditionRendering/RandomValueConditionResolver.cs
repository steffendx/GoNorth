...
namespace GoNorth.Services.Export.Dialog.ConditionRendering
{
    ...
    public class RandomValueConditionResolver :  BaseConditionRenderer<RandomValueConditionResolver.RandomValueConditionData>
    {
        ...
        public override string BuildConditionElementFromParsedData(RandomValueConditionResolver.RandomValueConditionData parsedData, GoNorthProject project, ExportPlaceholderErrorCollection errorCollection, KortistoNpc npc, ExportSettings exportSettings)
        {
