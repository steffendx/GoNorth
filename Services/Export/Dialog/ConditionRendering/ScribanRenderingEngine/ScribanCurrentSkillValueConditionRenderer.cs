...
namespace GoNorth.Services.Export.Dialog.ConditionRendering.ScribanRenderingEngine
{
    ...
    /// </summary>
    public class ScribanCurrentSkillValueConditionRenderer : ScribanValueConditionBaseRenderer
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public ScribanCurrentSkillValueConditionRenderer(ICachedExportDefaultTemplateProvider defaultTemplateProvider, IExportCachedDbAccess cachedDbAccess, IScribanLanguageKeyGenerator languageKeyGenerator, 
