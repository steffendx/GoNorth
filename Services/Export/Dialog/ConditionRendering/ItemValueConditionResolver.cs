...
namespace GoNorth.Services.Export.Dialog.ConditionRendering
{
    ...
    public class ItemValueConditionResolver : ValueConditionResolverBase
    {
        ...
        {
            return _defaultTemplateProvider.GetDefaultTemplateByType(project.Id, TemplateType.TaleConditionItemValue).Result;
        }
        ...
        {
            return (templateType == TemplateType.TaleConditionItemValue);
        }
    }
}