...
namespace GoNorth.Services.Export.Dialog.ActionRendering
{
    ...
    public class ChangeNpcStateActionRenderer : BaseActionRenderer<ChangeNpcStateActionRenderer.ChangeNpcStateActionData>
    {
        ...
        public override async Task<string> BuildActionFromParsedData(ChangeNpcStateActionRenderer.ChangeNpcStateActionData parsedData, ExportDialogData data, GoNorthProject project, ExportPlaceholderErrorCollection errorCollection, FlexFieldObject flexFieldObject, ExportSettings exportSettings)
        {
