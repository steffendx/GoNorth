...
namespace GoNorth.Services.Export.Dialog.ActionRendering
{
    ...
    /// </summary>
    public class OpenShopActionRenderer : BaseActionRenderer<OpenShopActionRenderer.OpenShopActionData>
    {
        /// <summary>
        ...
        public OpenShopActionRenderer(ICachedExportDefaultTemplateProvider defaultTemplateProvider)
        {
        ...
        public override async Task<string> BuildActionFromParsedData(OpenShopActionRenderer.OpenShopActionData parsedData, ExportDialogData data, GoNorthProject project, ExportPlaceholderErrorCollection errorCollection, KortistoNpc npc, ExportSettings exportSettings)
        {
        ...
        public override Task<string> BuildPreviewTextFromParsedData(OpenShopActionRenderer.OpenShopActionData parsedData, KortistoNpc npc, ExportPlaceholderErrorCollection errorCollection)
        {
        ...
        {
            return templateType == TemplateType.TaleActionOpenShop;
        }   
