...
namespace GoNorth.Services.Export.Dialog.ActionRendering
{
    ...
    /// </summary>
    public class ChangeTargetNpcStateActionRenderer : BaseActionRenderer<ChangeTargetNpcStateActionRenderer.ChangeTargetNpcStateActionData>
    {
        /// <summary>
        /// Change target npc state action data
        /// </summary>
        public class ChangeTargetNpcStateActionData
        {
            /// <summary>
            /// New State
            /// </summary>
        ...
        public override async Task<string> BuildActionFromParsedData(ChangeTargetNpcStateActionRenderer.ChangeTargetNpcStateActionData parsedData, ExportDialogData data, GoNorthProject project, ExportPlaceholderErrorCollection errorCollection, FlexFieldObject flexFieldObject, ExportSettings exportSettings)
        {
        ...
        {
            return templateType == TemplateType.TaleActionSetTargetNpcState;
        }   
