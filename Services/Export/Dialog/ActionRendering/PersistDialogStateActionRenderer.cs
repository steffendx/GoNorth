...
namespace GoNorth.Services.Export.Dialog.ActionRendering
{
    ...
    public class PersistDialogStateActionRenderer : BaseActionRenderer<PersistDialogStateActionRenderer.PersistDialogStateActionData>
    {
        ...
        public override Task<string> BuildPreviewTextFromParsedData(PersistDialogStateActionRenderer.PersistDialogStateActionData parsedData, KortistoNpc npc, ExportPlaceholderErrorCollection errorCollection)
        {
