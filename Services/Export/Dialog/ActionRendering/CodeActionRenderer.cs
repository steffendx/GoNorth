...
namespace GoNorth.Services.Export.Dialog.ActionRendering
{
    ...
    public class CodeActionRenderer : BaseActionRenderer<CodeActionRenderer.CodeActionData>
    {
        ...
        public override async Task<string> BuildActionFromParsedData(CodeActionRenderer.CodeActionData parsedData, ExportDialogData data, GoNorthProject project, ExportPlaceholderErrorCollection errorCollection, KortistoNpc npc, ExportSettings exportSettings)
        {
