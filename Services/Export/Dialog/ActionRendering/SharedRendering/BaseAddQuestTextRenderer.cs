...
namespace GoNorth.Services.Export.Dialog.ActionRendering.SharedRendering
{
    ...
    /// </summary>
    public abstract class BaseAddQuestTextRenderer : BaseActionRenderer<AddQuestTextData>
    {
        /// <summary>
        /// Cached Db Access
        /// </summary>
        ...
        public BaseAddQuestTextRenderer(IExportCachedDbAccess cachedDbAccess)
        {
        ...
        public override async Task<string> BuildActionFromParsedData(ExportTemplate template, AddQuestTextData parsedData, ExportDialogData data, ExportDialogData nextStep, GoNorthProject project, ExportPlaceholderErrorCollection errorCollection, 
        ...
        protected abstract Task<string> FillPlaceholders(ExportTemplate template, ExportPlaceholderErrorCollection errorCollection, AddQuestTextData parsedData, IFlexFieldExportable valueObject, FlexFieldObject flexFieldObject, 
        ...
        public override async Task<string> BuildPreviewTextFromParsedData(AddQuestTextData parsedData, FlexFieldObject flexFieldObject, ExportPlaceholderErrorCollection errorCollection, ExportDialogData child, ExportDialogData parent)
        {
            IFlexFieldExportable valueObject = await GetQuest(parsedData, errorCollection);
            if(valueObject == null)
            {
        ...
        private async Task<IFlexFieldExportable> GetQuest(AddQuestTextData parsedData, ExportPlaceholderErrorCollection errorCollection)
        {
