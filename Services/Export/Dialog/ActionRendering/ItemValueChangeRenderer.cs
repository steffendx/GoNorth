...
{
    /// <summary>
    /// Class for rendering an item value change action
    /// </summary>
    public class ItemValueChangeRenderer : ValueActionRenderBase
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            return await _defaultTemplateProvider.GetDefaultTemplateByType(project.Id, TemplateType.TaleActionChangeItemValue);
        }
        ...
        {
            return templateType == TemplateType.TaleActionChangeItemValue;
        }
    }
}