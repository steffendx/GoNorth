...
namespace GoNorth.Services.Export.Dialog.ActionRendering
{
    ...
    public class SetGameTimeActionRenderer : BaseActionRenderer<SetGameTimeActionRenderer.SetGameTimeActionData>
    {
        ...
        public override Task<string> BuildPreviewTextFromParsedData(SetGameTimeActionRenderer.SetGameTimeActionData parsedData, FlexFieldObject flexFieldObject, ExportPlaceholderErrorCollection errorCollection, ExportDialogData child, ExportDialogData parent)
        {
