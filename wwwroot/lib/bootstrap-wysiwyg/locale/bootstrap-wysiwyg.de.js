window.bootstrapWysiwyg = window.bootstrapWysiwyg || {};
bootstrapWysiwyg.local = bootstrapWysiwyg.local || {};

bootstrapWysiwyg.local.font = "Schriftart";
bootstrapWysiwyg.local.fontSize = "Schriftgröße";
bootstrapWysiwyg.local.fontSizeHuge = "Groß";
bootstrapWysiwyg.local.fontSizeNormal = "Normal";
...
bootstrapWysiwyg.local.strikeThrough = "Durchgestrichen";
bootstrapWysiwyg.local.underline = "Unterstrichen [Strg + U]";

bootstrapWysiwyg.local.bulletList = "Aufistung";
bootstrapWysiwyg.local.numberList = "Nummerierte Auflistung";
bootstrapWysiwyg.local.reduceIndent = "Einrückung verringern [Shift + Tab]";
bootstrapWysiwyg.local.indent = "Einrücken [Tab]";

bootstrapWysiwyg.local.alignLeft = "Linksbündig [Strg + L]";
bootstrapWysiwyg.local.alignCenter = "Zentriert [Strg + E]";
bootstrapWysiwyg.local.alignRight = "Rechtsbündig [Strg + R]";
bootstrapWysiwyg.local.justifyFull = "Blocksatz [Strg + J]";

bootstrapWysiwyg.local.hyperlink = "Link einfügen";
bootstrapWysiwyg.local.url = "URL";
bootstrapWysiwyg.local.hyperlinkAdd = "Einfügen";
